...
void main() => runApp(new MaterialApp(
  home: new PutAttention(),
  debugShowCheckedModeBanner: false,
));

class PutAttention extends StatefulWidget {
  @override
  _PutAttentionState createState() => new _PutAttentionState();
}

class _PutAttentionState extends State<PutAttention> {
