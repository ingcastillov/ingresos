         ...
         children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                                              SizedBox(),
                              Text('Saldo Disponible', style: TextStyle(color: Colors.white, fontSize: 15),),
              ],
            ),
          ),
                        ...
                        Container(
                          ...
                          child: Column(
                            children: <Widget>[
                               ...
                               SizedBox(),
                              Text('\u002484,692.87', style: TextStyle(color: Colors.white, fontSize: 40),),
                            ],
                          ),
                        ),
                        Container(
            ...
            child: Column(
              children: <Widget>[
                                              SizedBox(),
                              Text('Ver detalle', style: TextStyle(color: Colors.white, fontSize: 15),),
              ],
            ),
                        ),
                 ...
                 children: <Widget>[
                   ...
                   Container(
                     ...
                     child: Column(
                      children: <Widget>[
                        ListTile(
                         leading: Icon(Icons.account_balance_wallet, size: 50, color: Colors.blueGrey,),
                         title: Text('Ultimo deposito'),
                         subtitle: Text('\u002443,983.87', style: TextStyle(fontSize: 25),),
                         trailing: Container(child: IconButton(icon: Icon(Icons.arrow_forward_ios, size: 30, color: Colors.orange,), onPressed: (){})),
                        ),
                     ...
                     child: Column(
                      children: <Widget>[
                        ListTile(
                         ...
                         title: Text('Periodos anteriores', style: TextStyle(color: Colors.blueGrey,fontSize: 18),),
                         trailing: Container(child: IconButton(icon: Icon(Icons.arrow_forward_ios, size: 30, color: Colors.orange,), onPressed: (){})),
                        ),
