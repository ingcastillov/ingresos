...
class OtrosAutosFiltered extends StatefulWidget {
 ...
 final random = Random();
  ...
  @override
  _OtrosAutosFiltered createState() => _OtrosAutosFiltered();
}

class _OtrosAutosFiltered extends State<OtrosAutosFiltered> {
