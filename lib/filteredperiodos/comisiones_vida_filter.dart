...
class ComisionesVidaFiltered extends StatefulWidget {
 ...
 final random = Random();
  ...
  @override
  _ComisionesVidaFiltered createState() => _ComisionesVidaFiltered();
}

class _ComisionesVidaFiltered extends State<ComisionesVidaFiltered> {
