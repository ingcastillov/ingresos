...
class BonosVidaFiltered extends StatefulWidget {
 ...
 final random = Random();
  ...
  @override
  _BonosVidaFiltered createState() => _BonosVidaFiltered();
}

class _BonosVidaFiltered extends State<BonosVidaFiltered> {
