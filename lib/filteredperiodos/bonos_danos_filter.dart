...
class BonosDanosFiltered extends StatefulWidget {
 ...
 final random = Random();
  ...
  @override
  _BonosDanosFiltered createState() => _BonosDanosFiltered();
}

class _BonosDanosFiltered extends State<BonosDanosFiltered> {
