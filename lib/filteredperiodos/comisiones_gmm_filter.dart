...
class ComisionesGMMFiltered extends StatefulWidget {
 ...
 final random = Random();
  ...
  @override
  _ComisionesGMMFiltered createState() => _ComisionesGMMFiltered();
}

class _ComisionesGMMFiltered extends State<ComisionesGMMFiltered> {
...
//TABLA COMISIONES Y VIDA DE LO CONTRARIO TRAR GRAFICA CON DATOS GENERALES
   TablaMensual(
        ...
        porcentajeActual: 11, 
        porcentajePenultimo: 55, 
        porcentajeAntepenultimo: 11, 
        incremento: true, 
        incremento2: true, 
        incremento3: false
        )
