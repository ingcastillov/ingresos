...
class OtrosDanosFiltered extends StatefulWidget {
 ...
 final random = Random();
  ...
  @override
  _OtrosDanosFiltered createState() => _OtrosDanosFiltered();
}

class _OtrosDanosFiltered extends State<OtrosDanosFiltered> {
