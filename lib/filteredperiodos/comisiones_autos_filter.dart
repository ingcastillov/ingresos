...
class ComisionesAutosFiltered extends StatefulWidget {
 ...
 final random = Random();
  ...
  @override
  _ComisionesAutosFiltered createState() => _ComisionesAutosFiltered();
}

class _ComisionesAutosFiltered extends State<ComisionesAutosFiltered> {
