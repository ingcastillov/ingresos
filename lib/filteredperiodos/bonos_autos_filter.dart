...
class BonosAutosFiltered extends StatefulWidget {
 ...
 final random = Random();
  ...
  @override
  _BonosAutosFiltered createState() => _BonosAutosFiltered();
}

class _BonosAutosFiltered extends State<BonosAutosFiltered> {
